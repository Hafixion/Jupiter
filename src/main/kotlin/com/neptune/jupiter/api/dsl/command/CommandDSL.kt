...
import com.neptune.jupiter.api.extensions.command.*
...
inline fun WithPlugin<*>.command(
    ...
    coroutineScope: CoroutineScope = CoroutineScope(plugin.BukkitDispatchers.SYNC + job),
...
inline fun Plugin.command(
    ...
    vararg aliases: String = arrayOf(),
    job: Job = SupervisorJob(),
    coroutineScope: CoroutineScope = CoroutineScope(BukkitDispatchers.SYNC + job),
    block: CommandBuilderBlock
...
open class CommandDSL(
        ...
        private val coroutineScope: CoroutineScope = CoroutineScope(plugin.BukkitDispatchers.SYNC + job)
