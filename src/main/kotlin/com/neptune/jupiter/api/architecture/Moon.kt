package com.neptune.jupiter.api.architecture

import com.neptune.jupiter.api.architecture.lifecycle.*
import org.bukkit.plugin.java.JavaPlugin
import java.util.concurrent.ConcurrentHashMap

open class Moon : JavaPlugin() {
     ...
     */
    inline fun <P : Moon, T : LifecycleListener<P>> lifecycle(
            priority: Int = 1,
            block: () -> T
    ): T = block().also {
        registerKotlinPluginLifecycle(priority, it as LifecycleListener<Moon>)
    }
